...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/declineInvitation/{id}', 'ToDoController@declineInvitation')->name('declineInvitation');
    Route::get('/removeWorker/{id}', 'ToDoController@removeWorker')->name('removeWorker');
});
